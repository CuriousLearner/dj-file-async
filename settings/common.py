"""Django settings for dj-file-async project.
...
APPS_DIR = ROOT_DIR.path('dj_file_async')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'dj_file_async.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'dj_file_async.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'dj_file_async.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='dj-file-async')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='dj-file-async')
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'dj_file_async.urls'
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='dj-file-async <support@dj_file_async.com>')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[dj-file-async] ')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/dj_file_async'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'dj_file_async.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'dj_file_async.base.views.csrf_failure'
...
def get_release():
    import dj_file_async
    import os
    import raven
    release = dj_file_async.__version__
    try:
