...
Minimum requirements: **pip, fabric, python3, node, npm, redis & [PostgreSQL 11][install-postgres]**, setup is tested on Mac OSX only.
...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:CuriousLearner/dj-file-async-web.git; cd dj-file-async-web; fab init
...
[contributing]: http://github.com/CuriousLearner/dj-file-async-web/tree/master/CONTRIBUTING.md
