...
#  Settings
# ==========================================================================
env.project_name = 'dj_file_async'
...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['dev.dj_file_async.com']
    env.dotenv_path = '/home/ubuntu/dev/dj_file_async/.env'
...
def qa():
    ...
    env.remote = 'origin'
    env.branch = 'qa'
    env.hosts = ['qa.dj_file_async.com']
    env.dotenv_path = '/home/ubuntu/qa/dj_file_async/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.dj_file_async.com']
    env.dotenv_path = '/home/ubuntu/prod/dj_file_async/.env'
    env.config_setter = fab.run
